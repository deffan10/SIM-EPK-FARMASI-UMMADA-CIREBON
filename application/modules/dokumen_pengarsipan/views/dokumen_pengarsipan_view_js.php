    ...
    $('#add').click(function(){
      addRow();
		...
		jQuery(grid_selector).jqGrid({
			...
			subGrid : false,
			url: '<?php echo base_url()?>dokumen_pengarsipan/get_daftar/',
			datatype: "json",
      mtype: "POST",
			height: 250,
			colNames:['ID', 'No Protokol', 'Judul', 'Tanggal Dokumen & Arsip'],
			colModel:[
				...
				{name:'tgl_dokarsip', index:'tgl_upload', editable:false, align:'center'},
			], 
	    ...
	    rownumbers: true,
			...
			ondblClickRow: function (rowid, iRow, iCol, e) {
				window.location = '<?php echo base_url()?>dokumen_pengarsipan/form/'+rowid;
			},
		...
		function editRow(rowid) {
			window.location.href = '<?php echo base_url()?>dokumen_pengarsipan/form/'+rowid;
		}

		function addRow() {
			window.location.href = '<?php echo base_url()?>dokumen_pengarsipan/form/';
		}
