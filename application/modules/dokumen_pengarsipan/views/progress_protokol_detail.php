								...
								<div class="widget-body">
									<div class="widget-main">
										...
										if ($v[$i]['lanjut_telaah'] == 'TBD'){
											...
											echo '<textarea class="form-control" disabled="disabled">'.$v[$i]['alasan_tbd'].'</textarea>';
										}
										else if ($v[$i]['lanjut_telaah'] == 'DITOLAK'){
											echo '<strong>Alasan Ditolak:</strong><br/>';
											echo '<textarea class="form-control" disabled="disabled">'.$v[$i]['alasan_ditolak'].'</textarea>';
										}
