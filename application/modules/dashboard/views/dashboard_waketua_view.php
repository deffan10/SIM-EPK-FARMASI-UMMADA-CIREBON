		...
		<div class="widget-box transparent">
			<div class="widget-header widget-header-small">
				...
				<i class="ace-icon fa fa-flag orange"></i>
					Putusan Screening Jalur Telaah
				</h4>

				<div class="widget-toolbar action-buttons">
					<a href="#" data-action="reload" title="Perbarui" data-bind="click: init_putusan_awal()">
						<i class="ace-icon fa fa-refresh blue"></i>
					</a>
				</div>

				<div class="widget-toolbar">
					<small>Jumlah : <span data-bind="text: putusan_awal().length"></span></small>
				</div>
			</div>

			<div class="widget-body">
				<div class="widget-main padding-8 scrollable" data-size="220">
					<div id="putusan_awal" class="profile-feed" data-bind="foreach: putusan_awal">
