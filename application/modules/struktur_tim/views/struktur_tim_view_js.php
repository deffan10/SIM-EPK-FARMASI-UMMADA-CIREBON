      ...
      subgridtype : "json",
			...
			subGridRowExpanded: function (subgridDivId, rowId) {
				...
				$("#" + subgridTableId).jqGrid({
					url: '<?php echo base_url()?>struktur_tim/get_struktur_by_id/'+rowId,
					datatype: 'json',
          ...
          rowNum: 10000
			...
			datatype: "json",
			height: 250,
			colNames:['ID', 'Periode', 'Ketua', 'Aktif Tim KEPK'],
			colModel:[
	    ...
	    rownumbers: true,
			...
			ondblClickRow: function (rowid, iRow, iCol, e) {
				window.location = '<?php echo base_url()?>struktur_tim/form/'+rowid;
			},
			...
			editurl: "<?php echo base_url()?>struktur_tim/proses"
		});
		...
		function editRow(rowid) {
			window.location.href = '<?php echo base_url()?>struktur_tim/form/'+rowid;
		}

		function addRow() {
			window.location.href = '<?php echo base_url()?>struktur_tim/form/';
		}
