...
<div class="alert alert-block alert-info" data-bind="visible: !registered()">
  ...
  Masukkan NIK, email dan KEPK asal untuk memulai pendaftaran peneliti.
</div>
...
<form class="form-horizontal" role="form" id="frm" data-bind="visible: !registered()">
  ...
  <div class="form-group">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="url_kepk_lain"> Alamat URL KEPK Asal </label>
		<div class="col-sm-9">
			<input type="text" id="url_kepk_lain" placeholder="Alamat URL KEPK Asal" class="form-control" data-bind="value: url_kepk_lain" />
      <p class="text-danger"><small>Contoh: http://www.sim-epk-kepk.ac.id </small></p>
		</div>
	</div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
    	<div class="btn btn-purple" id="search_peneliti" data-bind="click: tampilkan_data_peneliti">Cari</div>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control search-query" placeholder="Nomor Anggota" data-bind="value: no_anggota" disabled="disabled" />
    </div>
  </div>
...
<div class="alert alert-block alert-success" data-bind="visible: registered()">
  ...
  <span class="bigger-125">Username dan Password sama dengan yang di SIM-EPK KEPK asal</span>
</div>
