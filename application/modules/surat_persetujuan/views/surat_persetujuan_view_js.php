    ...
    $('#add').click(function(){
      addRow();
		...
		jQuery(grid_selector).jqGrid({
			...
			subGrid : false,
			url: '<?php echo base_url()?>surat_persetujuan/get_daftar/',
			datatype: "json",
      mtype: "POST",
			height: 250,
	    ...
	    rownumbers: true,
			...
			ondblClickRow: function (rowid, iRow, iCol, e) {
				window.location = '<?php echo base_url()?>surat_persetujuan/form/'+rowid;
			},
			...
			caption: "Surat Persetujuan Etik"
		...
		function editRow(rowid) {
			window.location.href = '<?php echo base_url()?>surat_persetujuan/form/'+rowid;
		}

		function addRow() {
			window.location.href = '<?php echo base_url()?>surat_persetujuan/form/';
		}
