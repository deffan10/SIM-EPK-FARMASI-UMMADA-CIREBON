											...
											<tr data-bind="attr: {'class': level == 0 ? 'active' : ''}">
												...
												<td>
													<div class="control-group" data-bind="visible: just_header == 0">
														<div class="radio">
															<label>
																<input type="radio" class="ace" value="Ya" data-bind="checked: pil_penelaah, attr:{'name': $index().$data}, enable: pil_penelaah == 'Ya'" />
																<span class="lbl"> Ya</span>
															</label>
														</div>
														<div class="radio">
															<label>
																<input type="radio" class="ace" value="Tidak" data-bind="checked: pil_penelaah, attr:{'name': $index().$data}, enable: pil_penelaah == 'Tidak'" />
																<span class="lbl"> Tidak</span>
															</label>
														</div>
													</div>
										...
										<tbody data-bind="foreach: self_assesment2">
											<tr data-bind="attr: {'class': level == 0 ? 'active' : ''}">
												...
												<td>
													<div data-bind="if: level == 0">
														<strong><span data-bind="html: uraian_master"></span></strong>
														<br/><i><span data-bind="html: uraian == uraian_master ? '' : uraian"></span></i>
													</div>
													<div data-bind="if: level > 0">
														<span data-bind="html: uraian"></span>
													</div>
