<div class="widget-box transparent" id="recent-box">
	<div class="widget-header">
		...
		<span class="label label-lg label-yellow arrowed-in arrowed-in-right" data-bind="visible: klasifikasi > 1, text: lbl_klasifikasi"></span>
		...
		<div class="widget-toolbar no-border">
			<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="recent-tab">
				...
				<li>
					<a data-toggle="tab" href="#klasifikasi-tab">Klasifikasi Usulan</a>
				</li>
	...
	<div class="widget-body">
        ...
        ?>
					<h3 class="header smaller lighter blue">Resume <?php echo isset($resume[$i]['peresume']) ? $resume[$i]['peresume'] : '' ?></h3>
					<div class="row">
        ...
        <?php }} // end for & if (!empty(resume)) ?>
				...
				<div id="protokol-tab" class="tab-pane">
					<div class="row">
						<div class="col-sm-6">
                ...
                <div class="profile-info-row">
                  ...
                  <div class="profile-info-value">
                    ...
                    <a href="<?php echo base_url()?>telaah_cepat/download/<?php echo isset($sp['file_name']) ? rawurlencode(urlencode($sp['file_name'])) : 0;?>/<?php echo isset($sp['client_name']) ? rawurlencode(urlencode($sp['client_name'])) : 0;?>">
                ...
                <div class="profile-info-row">
                    ...
                    <a href="#" data-bind="click: function(){ showFile('uploads/<?php echo isset($bb['file_name']) ? $bb['file_name'] : 0;?>') }" title="Lihat File">
                      <i class="ace-icon fa fa-search bigger-110"></i>
										...
										<a href="<?php echo base_url()?>telaah_cepat/download/<?php echo isset($bb['file_name']) ? rawurlencode(urlencode($bb['file_name'])) : 0;?>/<?php echo isset($bb['client_name']) ? rawurlencode(urlencode($bb['client_name'])) : 0;?>">
											<i class="fa fa-download"></i>
										</a>
									</div>
								</div>
					...
					<h3 class="header smaller lighter blue">
						<div class="row">
							...
							<span class="col-sm-2 text-right">
								<a href="#" data-bind="click: print_protokol">
                    ...
                    <div class="form-group">
                      <div class="wysiwyg-editor" id="catatanBB" data-bind="event:{input: catatan_protokol}"></div>
                            ...
                            echo '<a href="#" data-bind="click: function(){ showFile(\'uploads/'.$lampiran_pep[$i]['file_name'].'\') }" title="Lihat File"><i class="ace-icon fa fa-search bigger-110"></i></a>&nbsp;&nbsp;';
														echo '<a href="';
														echo base_url().'telaah_cepat/download/'.rawurlencode(urlencode($lampiran_pep[$i]['file_name'])).'/'.rawurlencode(urlencode($lampiran_pep[$i]['client_name'])).'">';
          ...
          <div class="alert alert-info" data-bind="visible: id() == 0">
            ...
            Pilihan Penelaah beberapa item/poin <strong>7-Standar Kelainan Etik Penelitian</strong> secara default terisi "Ya"
					...
					<h3 class="header smaller lighter blue">
						<div class="row">
							<span class="col-sm-10">7 Standar</span>
							<span class="col-sm-2 text-right">
				...
				<div id="klasifikasi-tab" class="tab-pane">
          <div class="row">
            <span class="col-sm-12 text-right">
              <button class="btn btn-app btn-light btn-xs" data-bind="click: print_telaah_awal">
          ...
          <h3 class="header smaller lighter blue">Klasifikasi Usulan Penelaah Etik</h3>
					<div class="form-group">
						<div class="radio">
							<label>
								<input name="klas_telaah" type="radio" class="ace" value="1" data-bind="checked: klasifikasi_usulan" />
								<span class="lbl"> Exempted</span>
							</label>
							<label>
								<input name="klas_telaah" type="radio" class="ace" value="2" data-bind="checked: klasifikasi_usulan" />
								<span class="lbl"> Expedited</span>
							</label>
							<label>
								<input name="klas_telaah" type="radio" class="ace" value="3" data-bind="checked: klasifikasi_usulan" />
          ...
          <h3 class="header smaller lighter blue">Masalah Etik yang Mungkin Muncul dari Protokol Ini</h3>
          <div class="form-group">
...
<div class="clearfix form-actions">
	<div class="col-md-offset-3 col-md-9">
		<button class="btn btn-primary" id="submit" type="button" data-loading-text="Proses..." data-bind="click: function(data, event){save(false, data, event) }, enable: klasifikasi == 0">
