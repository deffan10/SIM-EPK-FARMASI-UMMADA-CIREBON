...
class Telaah_fullboard extends Userpage_Controller {

  public function __construct()
  {
    parent::__construct();

    $this->load->model('Telaah_fullboard_model', 'data_model');
  }
 
  public function index()
  {
    $data['title'] = APPNAME.' - Telaah Full Board';
    $data['page_header'] = 'Daftar Telaah Full Board';
    $data['breadcrumb'] = 'Telaah Full Board';
    $data['css_content'] = 'telaah_fullboard_view_css';
    $data['main_content'] = 'telaah_fullboard_view';
    $data['js_content'] = 'telaah_fullboard_view_js';
  ...
  public function form($id=0, $id_pep=0)
  {
    ...
    $data['title'] = APPNAME.' - Telaah Full Board';
    $data['page_header'] = $pep['revisi_ke'] > 0 ? 'Form Telaah Full Board (Perbaikan)' : 'Form Telaah Full Board';
    $data['breadcrumb'] = 'Telaah Full Board';
    $data['css_content'] = 'telaah_fullboard_form_css';
    $data['main_content'] = 'telaah_fullboard_form';
    $data['js_content'] = 'telaah_fullboard_form_js';
    ...
    if ($result){
      for($i=0; $i<count($result); $i++){
        $response->data[] = array(
          ...
          'judul' => $result[$i]['judul'],
          'tgl_fb' => isset($result[$i]['tgl_fullboard']) ? date('d/m/Y', strtotime($result[$i]['tgl_fullboard'])) : '',
          'jam_fb' => isset($result[$i]['jam_fullboard']) ? date('H:i', strtotime($result[$i]['jam_fullboard'])) : '',
...
/*  public function hapus()
  ...
  public function cetak_sa($id=0, $id_pep=0)
  {
    ...
    $html = '<p><b>Penelaah Full Board: '.$penelaah.'</b></p>';
  ...
  public function cetak_telaah_fullboard($id=0, $id_pep=0)
  {
    $this->load->library('Pdf');
