			...
			<div class="modal-body">
				<div class="row">
					<div class="form-group">
						<div class="col-sm-12">
							<select class="select2 form-control" id="protokol1" data-placeholder="Pilih protokol...">
								<option value=""> </option>
								<?php
								if ($protokol)
								{
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="form-group">
						<div class="col-sm-12">
							<select class="select2 form-control" id="protokol2" data-placeholder="Pilih protokol...">
								<option value=""> </option>
								<?php
								if ($protokol)
								{
