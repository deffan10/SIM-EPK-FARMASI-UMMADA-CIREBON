...
<div class="widget-box transparent" id="recent-box">
	<div class="widget-header">
		...
		<span class="label label-lg label-yellow arrowed-in arrowed-in-right"><?php echo isset($pengajuan['exp_to_fb']) && $pengajuan['exp_to_fb'] > 0 ? 'Expedited ke Full Board' : 'Full Board'; ?></span>
		...
		<div class="widget-main padding-4">
			<div class="tab-content padding-8">
                ...
                <div class="profile-info-row">
                    ...
                    <a href="<?php echo base_url()?>telaah_fullboard/download/<?php echo isset($sp['file_name']) ? rawurlencode(urlencode($sp['file_name'])) : 0;?>/<?php echo isset($sp['client_name']) ? rawurlencode(urlencode($sp['client_name'])) : 0;?>">
                ...
                <div class="profile-info-row">
                    ...
                    <a href="#" data-bind="click: function(){ showFile('uploads/<?php echo isset($bb['file_name']) ? $bb['file_name'] : 0;?>') }" title="Lihat File">
                      <i class="ace-icon fa fa-search bigger-110"></i>
										...
										<a href="<?php echo base_url()?>telaah_fullboard/download/<?php echo isset($bb['file_name']) ? rawurlencode(urlencode($bb['file_name'])) : 0;?>/<?php echo isset($bb['client_name']) ? rawurlencode(urlencode($bb['client_name'])) : 0;?>">
											<i class="fa fa-download"></i>
										</a>
									</div>
								</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="wysiwyg-editor" id="catatanBB" data-bind="event:{input: catatan_protokol}"></div>
                            ...
                            echo '<a href="#" data-bind="click: function(){ showFile(\'uploads/'.$lampiran_pep[$i]['file_name'].'\') }" title="Lihat File"><i class="ace-icon fa fa-search bigger-110"></i></a>&nbsp;&nbsp;';
														echo '<a href="';
														echo base_url().'telaah_fullboard/download/'.rawurlencode(urlencode($lampiran_pep[$i]['file_name'])).'/'.rawurlencode(urlencode($lampiran_pep[$i]['client_name'])).'">';
        ...
        <?php } } // end for & if !empty(resume) ?>
          ...
          <div class="row">
            <span class="col-sm-12 text-right">
              <button class="btn btn-app btn-light btn-xs" data-bind="click: print_telaah_fullboard">
