                    ...
                    <div class="widget-main">
                      ...
                      <form method="post" action="<?php echo base_url()?>auth/proses_login/">
                        <fieldset>
                          ...
                          <label class="block clearfix">
                            <p><small>Berapa hasil penjumlahan 2 bilangan berikut?</small></p>
                            <div class="input-group">
                              <span class="input-group-btn">
                                <span class="btn btn-sm btn-pink"><?php echo $captcha; ?> = </span>
                              </span>
                              <input type="text" class="col-xs-6 col-sm-6" name="captcha" />
                            </div>
                          </label>
