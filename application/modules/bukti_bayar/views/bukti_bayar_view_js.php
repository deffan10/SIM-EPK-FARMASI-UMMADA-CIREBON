    ...
    $('#add').click(function(){
      addRow();
		...
		jQuery(grid_selector).jqGrid({
			...
			subGrid : false,
			url: '<?php echo base_url()?>bukti_bayar/get_daftar/',
			datatype: "json",
      mtype: "POST",
			height: 250,
	    ...
	    ondblClickRow: function (rowid, iRow, iCol, e) {
				window.location.href = '<?php echo base_url()?>bukti_bayar/form/'+rowid;
	    },
			...
			editurl: "<?php echo base_url()?>bukti_bayar/proses"
		});
		...
		function addRow() {
			window.location.href = '<?php echo base_url()?>bukti_bayar/form/';
		}
