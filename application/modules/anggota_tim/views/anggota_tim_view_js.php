    ...
    $('#add').click(function(){
      addRow();
	    ...
	    ondblClickRow: function (rowid, iRow, iCol, e) {
				window.location.href = '<?php echo base_url()?>anggota_tim/form/'+rowid;
	    },
			...
			editurl: "<?php echo base_url()?>anggota_tim/proses"
		});
		...
		function addRow() {
			window.location.href = '<?php echo base_url()?>anggota_tim/form/';
		}
