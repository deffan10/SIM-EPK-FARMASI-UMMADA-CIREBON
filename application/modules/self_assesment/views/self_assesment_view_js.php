    ...
    $('#add').click(function(){
      addRow();
		...
		jQuery(grid_selector).jqGrid({
			...
			subGrid : false,
			url: '<?php echo base_url()?>self_assesment/get_daftar/',
			datatype: "json",
      mtype: "POST",
			height: 250,
			colNames:['ID', 'No Protokol', 'Judul', 'Tanggal Pengajuan', 'KEPK', 'Waktu Mulai', 'Waktu Selesai', 'Tanggal Self Assesment'],
			colModel:[
				...
				{name:'tgl_sa', index:'tgl_sa', width:50, editable:false},
			], 
	    ...
	    rownumbers: true,
			...
			ondblClickRow: function (rowid, iRow, iCol, e) {
				window.location = '<?php echo base_url()?>self_assesment/form/'+rowid;
			},
			...
			editurl: "<?php echo base_url()?>self_assesment/proses"
		...
		function editRow(rowid) {
			window.location.href = '<?php echo base_url()?>self_assesment/form/'+rowid;
		}
