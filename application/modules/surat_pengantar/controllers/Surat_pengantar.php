...
class Surat_pengantar extends Userpage_Controller {

  public function __construct()
  {
    parent::__construct();

    $this->load->model('Surat_pengantar_model', 'data_model');
  }
 
  public function index()
  {
    $data['title'] = APPNAME.' - Surat Pengantar';
    $data['page_header'] = 'Surat Pengantar';
    $data['breadcrumb'] = 'Surat Pengantar';
    $data['css_content'] = 'surat_pengantar_view_css';
    $data['main_content'] = 'surat_pengantar_view';
    $data['js_content'] = 'surat_pengantar_view_js';
  ...
  {
    $data['title'] = APPNAME.' - Surat Pengantar';
    $data['page_header'] = 'Form Surat Pengantar';
    $data['breadcrumb'] = 'Form Surat Pengantar';
    $data['css_content'] = 'surat_pengantar_form_css';
    $data['main_content'] = 'surat_pengantar_form';
    $data['js_content'] = 'surat_pengantar_form_js';
