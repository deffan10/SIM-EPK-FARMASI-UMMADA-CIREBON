    ...
    $('#add').click(function(){
      addRow();
		...
		jQuery(grid_selector).jqGrid({
			...
			subGrid : false,
			url: '<?php echo base_url()?>surat_pengantar/get_daftar/',
			datatype: "json",
      mtype: "POST",
			height: 250,
			colNames:['ID', 'No Protokol', 'Judul', 'Nomor', 'Tanggal'],
			colModel:[
				{name:'id', index:'id', hidden: true},
				{name:'no_protokol', index:'no_protokol', width:80, editable:false},
				{name:'judul', index:'judul', width:100, editable:false},
				{name:'nomor', index:'nomor', width:80, editable:false},
	    ...
	    ondblClickRow: function (rowid, iRow, iCol, e) {
				window.location.href = '<?php echo base_url()?>surat_pengantar/form/'+rowid;
	    },
			...
			editurl: "<?php echo base_url()?>surat_pengantar/proses"
		});
		...
		function addRow() {
			window.location.href = '<?php echo base_url()?>surat_pengantar/form/';
		}
