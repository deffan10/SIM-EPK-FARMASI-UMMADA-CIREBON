    ...
    <script type="text/javascript">
        ...
        $("#protokol1, #protokol2").select2({
          ...
          width: "100%"
    		...
    		$('#pilih1').click(function(){
    			...
    			window.location.href = '<?php echo base_url()?>telaah_expedited/form/0/'+id_pep;
    		})
    		...
    		jQuery(grid_selector1).jqGrid({
    			...
    			subGrid : false,
    			url: '<?php echo base_url()?>telaah_expedited/get_daftar1/',
    			datatype: "json",
          mtype: "POST",
    			height: 250,
    			colNames:['ID', 'ID PEP', 'No Protokol', 'Judul', 'Tanggal Pengajuan', 'KEPK', 'Waktu Mulai', 'Waktu Selesai', 'Tanggal Telaah', 'Kelayakan'],
    			colModel:[
    	    ...
    	    rownumbers: true,
    			...
    			ondblClickRow: function (rowid, iRow, iCol, e) {
    				...
    				window.location = '<?php echo base_url()?>telaah_expedited/form/'+rowid+'/'+id_pep;
    			},
    		...
    		jQuery(grid_selector2).jqGrid({
    			...
    			subGrid : false,
    			url: '<?php echo base_url()?>telaah_expedited/get_daftar2/',
    			datatype: "json",
          mtype: "POST",
    			height: 250,
    			colNames:['ID', 'ID PEP', 'No Protokol', 'Judul', 'Tanggal Pengajuan', 'Tanggal Perbaikan Protokol', 'Perbaikan ke', 'KEPK', 'Waktu Mulai', 'Waktu Selesai', 'Tanggal Telaah', 'Kelayakan'],
    			colModel:[
    				{name:'id', index:'id', hidden: true, editable:false},
    				{name:'id_pep', index:'id_pep', hidden: true, editable:false},
    				{name:'no_protokol', index:'no_protokol', editable:false},
    	    ...
    	    rownumbers: true,
    			...
    			caption: "Telaah Expedited (Perbaikan)"
    		...
    		jQuery(grid_selector1).jqGrid('navGrid',pager_selector1,
    			...
    			{
    				//delete record form
    				url: '<?php echo base_url()?>telaah_expedited/hapus/',
    				recreateForm: true,
    		...
    		function editRow1(rowid) {
    			var id_pep = jQuery(grid_selector1).jqGrid('getCell', rowid, 'id_pep');
    			window.location.href = '<?php echo base_url()?>telaah_expedited/form/'+rowid+'/'+id_pep;
    		}
    	...
    	var TelaahExpeditedModel = function(){
    		var self = this;
    	...
    	var App = new TelaahExpeditedModel();
