...
<script type="text/javascript">
	...
	App.do_upload = function(){
	  ...
	  $.ajax({
	    url: '<?php echo base_url()?>kop_surat/do_upload/',
	    type: 'post',
  ...
  App.pratinjau = function(){
    ...
    window.open('<?php echo base_url()?>kop_surat/pratinjau_cetak/'+file_name, '_blank');
  }
	...
	App.save = function(createNew){
	  ...
	  App.processing(true);
	  $.ajax({
	    url: '<?php echo base_url()?>kop_surat/proses',
	    type: 'post',
	    cache: false,
	    dataType: 'json',
	    data: data,
