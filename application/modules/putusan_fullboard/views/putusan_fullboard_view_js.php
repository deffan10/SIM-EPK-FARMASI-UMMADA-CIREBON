        ...
        $("#protokol1, #protokol2").select2({
          ...
          width: "100%"
    		...
    		$('#pilih1').click(function(){
    			...
    			window.location.href = '<?php echo base_url()?>putusan_fullboard/form/0/'+id_pep;
    		})
    		...
    		jQuery(grid_selector1).jqGrid({
    			...
    			subGrid : false,
    			url: '<?php echo base_url()?>putusan_fullboard/get_daftar1/',
    			datatype: "json",
          mtype: "POST",
    			height: 250,
    	    ...
    	    rownumbers: true,
    			...
    			ondblClickRow: function (rowid, iRow, iCol, e) {
    				...
    				window.location = '<?php echo base_url()?>putusan_fullboard/form/'+rowid+'/'+id_pep;
    			},
    			...
    			caption: "Putusan Telaah Full Board"
    		...
    		jQuery(grid_selector2).jqGrid({
    			...
    			subGrid : false,
    			url: '<?php echo base_url()?>putusan_fullboard/get_daftar2/',
    			datatype: "json",
          mtype: "POST",
    			height: 250,
    	    ...
    	    rownumbers: true,
    			...
    			caption: "Putusan Telaah Full Board (Perbaikan)"
    		...
    		jQuery(grid_selector1).jqGrid('navGrid',pager_selector1,
    			...
    			{
    				//delete record form
    				url: '<?php echo base_url()?>putusan_fullboard/hapus/',
    				recreateForm: true,
    		...
    		function editRow1(rowid) {
    			var id_pep = jQuery(grid_selector1).jqGrid('getCell', rowid, 'id_pep');
    			window.location.href = '<?php echo base_url()?>putusan_fullboard/form/'+rowid+'/'+id_pep;
    		}
