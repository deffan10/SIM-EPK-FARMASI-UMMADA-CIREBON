<div class="widget-box transparent" id="recent-box">
	...
	<div class="widget-body">
		<div class="widget-main padding-4">
              ...
              <div class="tabbable">
                ...
                <div class="tab-content">
                  <div id="a" class="tab-pane in active">
                    ...
                    <div class="row" data-bind="foreach: telaah_exp">
				...
				<div id="kelayakan_keputusan-tab" class="tab-pane">
                    ...
                    <a href="#" data-bind="click: function(data, event){$root.print_telaah_expedited(id, data, event) }">
								...
								<div class="widget-body">
									<div class="widget-main">
										<div class="radio">
											...
											<label>
												<input type="radio" class="ace" value="F" data-bind="checked: kelayakan, attr:{'name': $index().$data}, enable: kelayakan == 'F'" />
					...
					<h3 class="header smaller lighter blue">Ringkasan Putusan Telaah Expedited</h3>
					...
					<div class="row">
						<div class="radio">
							...
							<label>
								<input name="keputusan" type="radio" class="ace" value="F" data-bind="checked: keputusan" />
								<span class="lbl"> Full Board</span>
							</label>
						</div>
          ...
          <h3 class="header smaller lighter blue" data-bind="visible: keputusan() == 'F'">Penelaah, Pelapor, Lay Person & Konsultan Independen Full Board</h3>
          <div class="form-group" data-bind="visible: keputusan() == 'F'" style="width: 100%">
            <label>Penelaah Mendalam Full Board</label>
            <select class="select2 form-control" id="penelaah_mendalam" data-placeholder="Penelaah Mendalam" multiple="true" data-bind="selectedOptions: penelaah_mendalam">
              <option value=""> </option>
            <?php 
            if ($data_penelaah)
            {
          ...
          <div class="hr hr-dotted" data-bind="visible: keputusan() == 'F'"></div>

          <div class="form-group" data-bind="visible: keputusan() == 'F'" style="width: 100%">
            <label>Pelapor</label>
            <select class="select2 form-control" id="pelapor_telaah" data-placeholder="Pelapor" data-bind="value: pelapor_telaah">
              <option value=""> </option>
            </select>
          </div>
          ...
          <div class="form-group" data-bind="visible: keputusan() == 'F'" style="width: 100%">
            <label>Konsultan Independen Full Board</label>
...
<div class="clearfix form-actions">
	<div class="col-md-offset-3 col-md-9">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<button class="btn btn-success" id="kirim3" type="button" data-loading-text="Mengirim..." data-bind="click: kirim3, enable: save_ketua() > 0 && is_kirim() == 0, visible: keputusan() != 'F'">
			<i class="ace-icon fa fa-envelope bigger-110"></i>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<button class="btn btn-success" id="kirim3" type="button" data-loading-text="Mengirim..." data-bind="click: kirim3, enable: save_wakil_ketua() > 0 && is_kirim() == 0, visible: keputusan() != 'F'">
			<i class="ace-icon fa fa-envelope bigger-110"></i>
			<span data-bind="text: lbl_btn_kirim"></span> ke Kesekretariatan
		</button>
		<?php } ?>
