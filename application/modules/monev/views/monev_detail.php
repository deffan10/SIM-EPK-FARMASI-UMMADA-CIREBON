...
<dl>
	...
	<div class="hr hr-dotted"></div>
	<dt>Tanggal Monev</dt>
	<dd><?php echo isset($data['tanggal_monev']) ? date('d/m/Y', strtotime($data['tanggal_monev'])) : '-' ?></dd>
	<div class="hr hr-dotted"></div>
</dl>
			...
			<div class="widget-box" id="widget-box-1">
				...
				<div class="widget-body">
					<div class="widget-main">
						<?php echo isset($data['kendala']) ? stripslashes($data['kendala']) : ''?>
					</div>
				</div>
			</div>
		</div>
...
<div class="form-group">
	...
	if (isset($dokumen))
	{
		...
		{
			echo '<tr>';
			echo '<td width="2%"><a href="'.base_url().'monev/download/'.rawurlencode(urlencode($dokumen[$i]['file_name'])).'/'.rawurlencode(urlencode($dokumen[$i]['client_name'])).'" title="Unduh File"><i class="ace-icon fa fa-download bigger-110"></i></a></td>';
