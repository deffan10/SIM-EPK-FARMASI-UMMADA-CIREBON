...
class Monev extends Userpage_Controller {

  public function __construct()
  {
    parent::__construct();

    $this->load->model('Monev_model', 'data_model');
  }
 
  public function index()
  {
    $data['title'] = APPNAME.' - Monev Penelitian';
    $data['page_header'] = 'Monev Penelitian';
    $data['breadcrumb'] = 'Monev Penelitian';
    $data['css_content'] = 'monev_view_css';
    $data['main_content'] = 'monev_view';
    $data['js_content'] = 'monev_view_js';
  ...
  {
    $data['title'] = APPNAME.' - Monev Penelitian';
    $data['page_header'] = 'Form Monev Penelitian';
    $data['breadcrumb'] = 'Form Monev Penelitian';
    $data['css_content'] = 'monev_form_css';
    $data['main_content'] = 'monev_form';
    $data['js_content'] = 'monev_form_js';
  ...
  {
    $data['title'] = APPNAME.' - Monev Penelitian';
    $data['page_header'] = 'Detail Monev Penelitian';
    $data['breadcrumb'] = 'Detail Monev Penelitian';
    $data['css_content'] = 'monev_detail_css';
    $data['main_content'] = 'monev_detail';
    $data['js_content'] = 'monev_detail_js';
