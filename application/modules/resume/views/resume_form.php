...
<div class="row">
	<div class="col-sm-6">
		<h3 class="header smaller lighter blue">
			<div class="row">
				<span class="col-sm-12">Surat Pengantar Protokol</span>
			</div>
		</h3>
      ...
      <?php if (isset($sp['client_name']) && $sp['client_name'] !== "") { ?>
          ...
          <a href="#" data-bind="click: function() { downloadFile('<?php echo isset($sp['file_name']) ? rawurlencode(urlencode($sp['file_name'])) : 0;?>', '<?php echo isset($sp['client_name']) ? $sp['client_name'] : 0;?>')}">
	...
	<div class="col-sm-6">
		<h3 class="header smaller lighter blue">
			<div class="row">
				<span class="col-sm-12">Bukti Bayar</span>
			</div>
		</h3>
		<div class="profile-user-info profile-user-info-striped">
			<div class="profile-info-row">
      ...
      <?php if (isset($data['client_name']) && $data['client_name'] !== "") { ?>
          ...
          <a href="#" data-bind="click: function() { downloadFile('<?php echo isset($bb['file_name']) ? rawurlencode(urlencode($bb['file_name'])) : 0;?>', '<?php echo isset($bb['client_name']) ? $bb['client_name'] : 0;?>')}">
						<i class="fa fa-download"></i>
					</a>
				</div>
			</div>
...
<h3 class="header smaller lighter blue">Lanjut Screening Jalur Telaah?</h3>
<div class="row">
	<div class="radio">
		<label>
