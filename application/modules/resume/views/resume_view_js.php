        ...
        $("#protokol").select2({
          ...
          width: "100%"
    		...
    		$('#pilih').click(function(){
    			...
    			window.location.href = '<?php echo base_url()?>resume/form/0/'+id_pep;
    		})
    		...
    		jQuery(grid_selector).jqGrid({
    			...
    			subGrid : false,
    			url: '<?php echo base_url()?>resume/get_daftar/',
    			datatype: "json",
          mtype: "POST",
    			height: 250,
    			colNames:['ID', 'ID PEP', 'No Protokol', 'Judul', 'Tanggal Pengajuan', 'KEPK', 'Waktu Mulai', 'Waktu Selesai', 'Tanggal Resume'],
    			colModel:[
    				...
    				{name:'tgl_resume', index:'tgl_resume', editable:false, align:'center'},
    			], 
    	    ...
    	    rownumbers: true,
    			...
    			ondblClickRow: function (rowid, iRow, iCol, e) {
    				...
    				window.location.href = '<?php echo base_url()?>resume/form/'+rowid+'/'+id_pep;
    			},
    			...
    			caption: "Resume Protokol",
					editurl: "<?php echo base_url()?>resume/proses"    	
    		});
