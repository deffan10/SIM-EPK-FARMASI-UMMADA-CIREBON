...
class Resume extends Userpage_Controller {
  ...
  public function form($id=0, $id_pep=0)
  {
    ...
    {
      $resume_default .= '<b>Lampiran</b><br/>';
      $lampiran1 = array();
      $lampiran5 = array();
      $lampiran6 = array();
      ...
      else if (isset($pep['uraiancc1'])){
        $resume_default .= '- CV Peneliti Utama<br/>';
        $resume_default .= stripslashes($pep['uraiancc1']);
        $resume_default .= '<br/>';
      }
      else
      ...
      else if (isset($pep['uraiancc5'])){
        $resume_default .= '- Instrumen/Kuesioner, dll<br/>';
        $resume_default .= stripslashes($pep['uraiancc5']);
        $resume_default .= '<br/>';
      }
      else
      ...
      else if (isset($pep['uraiancc6'])){
        $resume_default .= '- Informed Consent 35 butir<br/>';
        $resume_default .= stripslashes($pep['uraiancc6']);
        $resume_default .= '<br/>';
      }
      else
  ...
  public function validation_form()
  {
    ...
    $this->form_validation->set_rules('lanjut_telaah_old', 'Lanjut Screening Jalur Telaah?', 'callback_cek_lanjut_telaah_sebelumnya');
  ...
  function cek_lanjut_telaah_sebelumnya($lanjut_telaah_old)
  {
    ...
    else
    {
      ...
      {
        if ($lanjut_telaah == 'YA')
          $this->form_validation->set_message('cek_lanjut_telaah_sebelumnya', 'Tidak bisa melakukan screening jalur telaah karena protokol sudah dibuat surat perbaikan.');
        else if ($lanjut_telaah == 'TBD')
          $this->form_validation->set_message('cek_lanjut_telaah_sebelumnya', 'Tidak bisa diubah ke TBD karena protokol sudah melalui screening jalur telaah.');
        else if ($lanjut_telaah == 'DITOLAK')
          $this->form_validation->set_message('cek_lanjut_telaah_sebelumnya', 'Tidak bisa diubah menjadi DITOLAK karena protokol sudah melalui screening jalur telaah atau sudah dibuat surat perbaikan.');
  ...
  function hapus()
  {
    ...
    {
      $response->isSuccess = FALSE;
      $response->message = 'Protokol sudah melalui screening jalur telaah atau sudah dibuat surat perbaikan.';
    }
    else
    {
