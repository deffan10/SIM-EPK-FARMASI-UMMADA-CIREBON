...
class Surat_pembebasan extends Userpage_Controller {

  public function __construct()
  {
    parent::__construct();

    $this->load->model('Surat_pembebasan_model', 'data_model');
  }
 
  public function index()
  {
    $data['title'] = APPNAME.' - Surat Pembebasan Etik';
    $data['page_header'] = 'Daftar Surat Pembebasan Etik';
    $data['breadcrumb'] = 'Surat Pembebasan Etik';
    $data['css_content'] = 'surat_pembebasan_view_css';
    $data['main_content'] = 'surat_pembebasan_view';
    $data['js_content'] = 'surat_pembebasan_view_js';
  ...
  {
    $data['title'] = APPNAME.' - Surat Pembebasan Etik';
    $data['page_header'] = 'Form Surat Pembebasan Etik';
    $data['breadcrumb'] = 'Surat Pembebasan Etik';
    $data['css_content'] = 'surat_pembebasan_form_css';
    $data['main_content'] = 'surat_pembebasan_form';
    $data['js_content'] = 'surat_pembebasan_form_js';
  ...
  public function get_daftar()
  {
    ...
    if ($result){
      for($i=0; $i<count($result); $i++){
        $response->rows[] = array(
          'id' => $result[$i]['id_ethical_exemption'],
    ...
    if ($result){
      for($i=0; $i<count($result); $i++){
        $response->data[] = array(
          ...
          'pil_sekretaris' => $result[$i]['pilihan_sekretaris'],
