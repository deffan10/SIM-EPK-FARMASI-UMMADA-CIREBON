    ...
    <script type="text/javascript">
        ...
        $('#add').click(function(){
          ...
          mtype: "POST",
    			height: 250,
    			colNames:['ID', 'No Protokol', 'Judul', 'Ketua Pelaksana / Peneliti Utama', 'No. Telepon', 'Email', 'Tanggal Fullboard', 'Jam Fullboard', 'Tempat Fullboard', 'Tanggal Pemberitahuan'],
    			colModel:[
    				...
    				{name:'nama_ketua', index:'nama_ketua', editable:false},
    				{name:'telp_peneliti', index:'telp_peneliti', editable:false},
    				{name:'email_peneliti', index:'email_peneliti', editable:false},
    	    ...
    	    rownumbers: true,
    			...
    			ondblClickRow: function (rowid, iRow, iCol, e) {
    				window.location = '<?php echo base_url()?>pemberitahuan_fullboard/form/'+rowid;
    			},
    		...
    		function editRow(rowid) {
    			window.location.href = '<?php echo base_url()?>pemberitahuan_fullboard/form/'+rowid;
    		}

    		function addRow() {
    			window.location.href = '<?php echo base_url()?>pemberitahuan_fullboard/form/';
    		}
